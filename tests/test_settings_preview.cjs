...
assert.match(settings, /md:pl-\[368px\]/, 'במחשב נשמר מקום לחלון בצד שמאל');
...
assert.match(preview, /function MiniCard/, 'הכרטיסים מוצגים כהדמיה ממשית ולא כרשימת שמות');
assert.match(preview, /מסך מוקטן של האפליקציה/, 'מובהר למשתמש שהוא רואה את האפליקציה עצמה');
