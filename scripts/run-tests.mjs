...
const libBundles = [
  ...
  ['lib/standingOrderForecast.ts', join(OUT, 'standingOrderForecast.js')],
  ['lib/cashDonations.ts', join(OUT, 'cashDonations.js')],
  ['lib/dataCleanup.ts', join(OUT, 'dataCleanup.js')],
  ['lib/family.ts', join(OUT, 'family.js')],
