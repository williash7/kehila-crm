...
export const FEATURE_CATALOG: FeatureDefinition[] = [
  ...
  {
    id: 'global-search', icon: '🔎', title: 'חיפוש בכל האפליקציה', category: 'start', tab: 'home',
    summary: 'האייקון בראש הדשבורד מחפש יחד אנשי קשר, תרומות, פעילויות, קמפיינים ומשימות.',
    practical: 'החיפוש נפתח מעל הדשבורד, ולחיצה על תוצאה פותחת ומדגישה את הפריט המדויק.',
  ...
  },
  {
    ...
    summary: 'תיקון סכום, תאריך, אמצעי תשלום, ייעוד, מזומן ושיוך שגוי — מכל מסך שבו התרומה מופיעה: תרומות, מרכז הכספים, כרטיס איש הקשר וקמפיין. אותו טופס, והשינוי מופיע מיד בכולם.',
  ...
  {
    id: 'finance-center', icon: '💼', title: 'תזרים המזומנים', category: 'money', tab: 'finance',
    summary: 'כמה כסף נכנס, כמה יצא, כמה יש עכשיו ומה מותר להוציא — כולל התחייבויות והתחשבנות אישית.',
  ...
  {
    id: 'cashflow', icon: '📈', title: 'תנועות עם יתרה רצה', category: 'money', tab: 'finance',
    summary: 'רשימת כל התנועות, וכל שורה מציגה כמה נשאר בחשבון באותו רגע. לצידה סיכום חודשי וצפי לחודשים הבאים.',
    practical: 'רשימת סכומים אומרת מה קרה; היתרה הרצה אומרת איפה עמדת אחרי שזה קרה — וזו השאלה לפני שמתחייבים. היתרה מחושבת על כל התנועות ולא על המסונן, כדי שסינון לא ישנה מה היה בחשבון בתאריך מסוים.',
    data: ['תאריכי תנועות', 'סכומים', 'ייעודים', 'מקורות ותנועות צפויות', 'יתרת הפתיחה'],
  },
  {
  ...
  {
    id: 'quick-inbox', icon: '📥', title: 'קליטה מהירה', category: 'planning', tab: 'home',
    summary: 'האייקון בראש הדשבורד פותח מקום זמני לרשום מידע במהירות לפני שממיינים אותו.',
