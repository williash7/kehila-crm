...
export const FEATURE_CATALOG: FeatureDefinition[] = [
  ...
  },
  {
    ...
    summary: 'לכל תרומת מזומן נקבע מה קרה עם הכסף: הופקד בעמותה, בקופת הפעילות, נלקח כמשכורת, נשמר בצד או טרם סווג.',
    practical: 'שטר ביד ושטר בבנק נראים זהה ברשימה ומתנהגים הפוך בתזרים. „נלקח כמשכורת” סוגר בבחירה אחת גם את ההכנסה וגם את ההוצאה, בלי לרשום שתי תנועות נפרדות.',
    data: ['מיקום מזומן', 'אמצעי תשלום', 'העברות והתחשבנות קשורות'],
  },
  {
    id: 'unresolved-cash-alert', icon: '⚠️', title: 'אזהרת מזומן שמחכה להחלטה', category: 'money', tab: 'finance',
    summary: 'מונה ומציג את כל תרומות המזומן שלא נקבע מה קרה עם הכסף שלהן, עם רשימה שמה ותאריך.',
    practical: 'מזומן שלא סווג אינו נספר ביתרה. בלי הרשימה אי אפשר לדעת אילו תרומות חוסמות את החשבון.',
    data: ['תרומות מזומן ללא יעד', 'סכום כולל', 'שם, תאריך וסכום לכל תרומה'],
  },
  {
    id: 'bulk-cash-decision', icon: '✅', title: 'סיווג מזומן בלחיצה אחת', category: 'money', tab: 'finance',
    summary: 'מסמנים תרומות מזומן פתוחות — או את כולן — ובוחרים יעד אחד שיחול על כולן. אפשר גם להחליט על כל תרומה בנפרד באותו מסך.',
    practical: 'עשרים תרומות מזומן מאותו אירוע שכולן הופקדו יחד הן פעולה אחת, לא עשרים. אם חלק מהעדכונים נכשלו, מוצג בשם מי נכשל והרשימה נשארת פתוחה לניסיון חוזר.',
    data: ['תרומות מזומן ללא יעד', 'יעד המזומן הנבחר', 'תוצאת העדכון לכל שורה'],
  },
  {
    id: 'standing-order-forecast', icon: '📅', title: 'הוראות קבע בתחזית החודשית', category: 'money', tab: 'finance',
    summary: 'חוזה את מועדי החיוב הבאים של כל הוראה פעילה ומציג, חודש מול חודש, כמה צפוי להיכנס מול כמה צריך לצאת.',
    practical: 'בלי זה התחזית רואה רק את מה שיוצא, וצ׳ק שיוצא בעוד שלושה חודשים גורם לה לומר „אין כסף” בזמן שהוראות הקבע ממשיכות להיכנס.',
    data: ['סכום ומועד חיוב לכל הוראה פעילה', 'מספר החיובים שנותרו', 'התחייבויות והכנסות מתוכננות באותו חודש'],
  },
  {
    id: 'finance-row-delete', icon: '🗑️', title: 'מחיקת שורה ממרכז הכספים', category: 'money', tab: 'finance',
    summary: 'מוחק כל שורה מרשימת התנועות — גם תרומה שנקראה מהיומן, לא רק תנועה שהוזנה ידנית.',
    practical: 'לשורה שנרשמה בטעות „מבוטל” הוא רעש קבוע שאי אפשר להיפטר ממנו. חיובי הוראת קבע מוגנים ואינם נמחקים, כי הם נוצרים מחדש בסריקה הבאה.',
    data: ['תנועות כספיות', 'שורות תרומה ביומן'],
  },
  {
